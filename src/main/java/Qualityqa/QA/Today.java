...
public class Today {
	...
	public void setup() throws InterruptedException {
		...
		// Load Excel data into loginDataList
		excelRead();
	}
	...
	public Object[][] getSearchData() {
		return new Object[][] { { "TV" }, { "Shoes" }, { "Mobile" }
	...
	public void searchForItem(String searchQuery) throws InterruptedException {
		...
		Assert.assertTrue(driver.getTitle().contains(searchQuery),
				"Search results page title does not contain '" + searchQuery + "'");
	...
	public void addPhoneToCart() throws InterruptedException {
		...
		driver.findElement(By.xpath(
				"/html/body/div[4]/div/div[3]/div[8]/div[8]/div/div[1]/div/div[1]/div/div/div[2]/div/div[2]/div/form/div/div/div[37]/div[1]/span/span/span/input"))
				.click();
